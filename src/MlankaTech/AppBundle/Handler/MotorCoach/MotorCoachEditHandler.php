...
/**
 * MlankaTech\AppBundle\Handler\MotorCoach\MotorCoachEditHandler.
 *
 * @DI\Service("mlanka_tech_app.motor_coach_edit_handler")
 * @author Mfana Ronald Conco <ronald.conco@mlankatech.co.za>
 * @subpackage Handler\User
 * @version 0.0.1
 */
class MotorCoachEditHandler
{
    /**
     * Monolog logger.
     *
    ...
    {
        $this->logger->info('MotorCoachEditHandler handle()');
        ...
        $this->motorCoachManager->update($validMotorCoach);
        $this->flashManager->getSuccessMessage('Motor coach was updated successfully!');
        return true;
    }
}
