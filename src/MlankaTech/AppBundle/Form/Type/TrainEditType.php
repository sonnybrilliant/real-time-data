...
/**
 * MlankaTech\AppBundle\Form\Type\TrainEditType
 *
 * @DI\Service("mlanka_tech_app.form.type.train.edit")
 * @DI\Tag("form.type", attributes = {"alias" = "TrainEditType"})
 * @author Mfana Ronald Conco <ronald.conco@mlankatech.co.za>
 * @package MlankaTechAppBundle
 * @subpackage Form\User
 * @version 0.0.1
 */
class TrainEditType extends AbstractType
{
